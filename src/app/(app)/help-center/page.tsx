...
const faqSections = [
  {
    ...
    items: [
      ...
      { q: "How do I connect my social accounts?", a: "Go to Settings → Integrations. You can connect Gmail and Google Calendar today. TikTok, Instagram, and YouTube integrations are coming soon." },
    ],
  },
  {
