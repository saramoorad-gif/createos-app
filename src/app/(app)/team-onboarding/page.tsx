      ...
      <div className="bg-white border-[1.5px] border-[#D8E8EE] rounded-[16px] p-8">
        ...
        {step === 5 && (
          <div className="text-center space-y-4">
            ...
            <button onClick={() => window.location.href = "/dashboard"} className="bg-[#1E3F52] text-white rounded-[8px] px-8 py-3 text-[14px] font-sans hover:bg-[#2a5269]" style={{ fontWeight: 600 }}>Go to dashboard →</button>
          </div>
        )}
      </div>
    </div>
