...
export async function POST(req: NextRequest) {
  ...
  // Always set subscription_status to "cancelled" regardless of prior
  // state — leaving it as "trialing" or null after a downgrade lets
  // SubscriptionGate keep treating the account as paid in some
  // permutations. "cancelled" + account_type=free is the canonical
  // "downgraded" state.
