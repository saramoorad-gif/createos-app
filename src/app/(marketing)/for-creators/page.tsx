...
const features = [
  ...
  },
  {
    ...
    italicWord: "contract",
    headingEnd: " again",
    desc: "Upload any brand contract and get a plain-English analysis in seconds. Red flags, missing clauses, and AI-suggested counter-language — so you negotiate from strength.",
    bullets: [
