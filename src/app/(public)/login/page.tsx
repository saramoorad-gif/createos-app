        ...
        <div className="bg-white border border-[#E5E0D8] rounded-[10px] p-6">
          ...
          {magicLinkSent ? (
            <div className="text-center py-4">
              ...
              <h3 className="text-[18px] font-serif text-[#1C1714]">
                Check your email
              </h3>
              <p className="text-[13px] font-sans text-[#9A9088] mt-1">
                We sent a magic link to{" "}
                <span className="font-medium text-[#1C1714]">{email}</span>
              </p>
              <button
                onClick={() => {
                ...
                className="text-[13px] font-sans text-[#C4714A] hover:underline font-medium mt-4"
              >
                Back to sign in
              </button>
            </div>
            ...
            <>
              {/* Mode toggle */}
              <div className="flex rounded-[10px] bg-[#F7F4EF] p-1 mb-5">
                <button
                  onClick={() => {
                    setMode("password");
                    setError("");
                  ...
                  className={`flex-1 flex items-center justify-center gap-1.5 rounded-[8px] px-3 py-1.5 text-[13px] font-sans font-medium transition-colors ${
                    mode === "password"
                      ? "bg-white text-[#1C1714] shadow-sm border border-[#E5E0D8]"
                      : "text-[#9A9088]"
                  }`}
                >
                  Password
              ...
              {mode === "magic" && (
                <form onSubmit={handleMagicLink} className="space-y-4">
                  ...
                  <p className="text-[11px] text-center font-sans text-[#9A9088]">
