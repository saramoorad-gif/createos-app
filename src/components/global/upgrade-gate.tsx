    ...
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="max-w-md text-center px-6">
        ...
        <h2 className="text-[24px] font-serif text-[#1A2C38] mb-3">
          Upgrade to <em className="italic text-[#7BAFC8]">Influencer</em>
        </h2>
        ...
        <div className="space-y-3">
          ...
          >
            <Sparkles className="h-4 w-4" /> Upgrade to Influencer — $39/mo
          </Link>
          <p className="text-[12px] font-sans text-[#8AAABB]">
            Includes audience analytics, revenue forecasting, tax export, and more.
          </p>
        </div>
        ...
        <div className="mt-8 bg-white border-[1.5px] border-[#D8E8EE] rounded-[10px] p-5 text-left">
          ...
          <div className="space-y-2.5">
            {[
              ...
              "Advanced media kit with stats",
              "Everything in UGC plan",
            ].map((item, i) => (
