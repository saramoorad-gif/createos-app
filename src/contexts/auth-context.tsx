...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  async function fetchProfile(userId: string): Promise<Profile | null> {
    try {
      ...
      const typed = (data as Profile | null) ?? null;
      setProfile(typed);
      return typed;
    } catch (e) {
  ...
  return (
    <AuthContext.Provider value={{ user, profile, loading, signOut, refreshProfile: async () => (user ? await fetchProfile(user.id) : null) }}>
      {children}
